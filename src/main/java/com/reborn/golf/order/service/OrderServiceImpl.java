...
import com.reborn.golf.common.exception.HighTokenPriceVolatilityException;
...
import com.reborn.golf.order.repository.OrderRepository;
...
public class OrderServiceImpl implements OrderService {
    ...
    public OrdersDto order(Integer memberIdx, OrdersDto ordersDto) {
        //유저 정보
        Member member = memberRepository.getMemberWithWallet(memberIdx)
        ...
        } catch (IamportResponseException | IOException | ClassNotFoundException | InvocationTargetException | NoSuchMethodException | InstantiationException | IllegalAccessException | TransactionException e) {
            try {
